...
public void asignCoursesToPromotedStudents(int year, String session) {
        ...
        enrollmentRepository.findDistinctStudentsBySession(year, session);
    }
    ...
    // query likho
    // insert into StudentCourseEnrollment (student_id, course_id, course_offering_id, grade, marks. gpa)
